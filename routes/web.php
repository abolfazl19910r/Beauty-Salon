...
Route::prefix('admin/reports')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/daily', [ReportsController::class, 'dailyRevenue']);
    Route::get('/weekly', [ReportsController::class, 'weeklyRevenue']);
    Route::get('/monthly', [ReportsController::class, 'monthlyRevenue']);
    Route::get('/specialists', [ReportsController::class, 'specialistPerformance']);
    Route::get('/customer-satisfaction', [ReportsController::class, 'customerSatisfaction']);
    Route::get('/popular-services', [ReportsController::class, 'popularServices']);
