...
- بررسی دستی برداشت‌های `processing` با `needs_manual_check` و تراکنش‌هایی که ۲۴ ساعت بی‌پاسخ موندن (لاگ) — فعلاً فقط در
  لاگ و جزئیات برداشت دیده می‌شن؛ یک فیلتر/هشدار در پنل مدیریت مفیده.
