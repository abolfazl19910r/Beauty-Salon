...
- ممیزی بقیه‌ی فهرست‌ها/آمارهای مدیریت روی جدول‌های بدون salon_id (مثل نشت برداشت/کیف پول ۲۰۲۶-۰۹-۲۶): هر repository
  که `$this->model` رو مستقیم می‌پرسه و مدلش scope سالن نداره.
