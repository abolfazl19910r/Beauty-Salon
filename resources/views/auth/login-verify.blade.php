    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-lg hover-shadow">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800">تایید ورود</h2>
                <p class="text-gray-600 mt-2">کد تایید ارسال شده به موبایل خود را وارد کنید</p>
            </div>
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-700">
                        <p class="font-medium">نکته امنیتی:</p>
                        <p class="mt-1">کد تایید خود را با هیچ کس به اشتراک نگذارید</p>
                    </div>
                </div>
            </div>
        </div>
