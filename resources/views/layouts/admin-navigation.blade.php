    ...
    <nav class="mt-4 px-2">
        ...
        <div class="py-2">
            ...
            <div class="py-2">
                ...
                <x-admin-nav-link href="{{ route('admin.wallet.index') }}" :active="request()->routeIs('admin.wallet.index')"
                                  class="flex items-center px-3 py-2.5 mb-1 text-sm font-medium rounded-lg transition-colors">
                ...
                <x-admin-nav-link href="{{ route('admin.wallet.withdrawals') }}" :active="request()->routeIs('admin.wallet.withdrawals*')"
                                  class="flex items-center px-3 py-2.5 mb-1 text-sm font-medium rounded-lg transition-colors">
                    <svg class="w-5 h-5 ml-2 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor">
