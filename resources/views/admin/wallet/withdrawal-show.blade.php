                    ...
                    <div class="rounded-xl p-5 mt-4" style="background:var(--admin-surface); border:1px solid var(--admin-border);">
                        ...
                        @else
                            <div class="rounded-lg p-3 text-xs leading-6" style="background:var(--admin-bg); color:var(--admin-text-dim);">
                                تسویه‌ی خودکار برای این سالن فعال نیست. برای فعال‌سازی، مالک سالن باید در «درگاه‌های پرداخت»
                                اطلاعات تسویه‌ی درگاه زرین‌پال یا زیبال سالن را وارد کند. تا آن زمان، مبلغ را دستی واریز کنید و کد پیگیری را در فرم بالا ثبت کنید.
                            </div>
                        @endif
                    </div>
