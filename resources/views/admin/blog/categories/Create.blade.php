...
@section('content')
    <div class="fade-in max-w-xl">
        <div class="flex justify-between items-center mb-5">
            <h1 class="text-xl font-bold" style="color:var(--admin-text);">دسته‌بندی جدید</h1>
            ...
            <form action="{{ route('admin.blog.categories.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="order" value="{{ old('order') }}" min="0" placeholder="خودکار"
                               class="w-full rounded-lg px-3 py-2 text-sm"
                               style="border:1px solid var(--admin-border); background:var(--admin-bg); color:var(--admin-text);">
                        <p class="text-xs mt-1" style="color:var(--admin-text-light);">اگر خالی بماند، به‌صورت خودکار بعد از آخرین دسته‌بندی قرار می‌گیرد.</p>
