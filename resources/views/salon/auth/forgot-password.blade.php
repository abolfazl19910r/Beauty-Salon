<x-guest-layout>
    ...
    <form method="POST" action="{{ route('salon.password.send') }}" class="space-y-5">
        @csrf
        ...
        <p class="text-center">
            <a href="{{ route('salon.login') }}" class="text-sm text-[#E6CD8A]/70 hover:text-[#E6CD8A] transition-colors">
                ← بازگشت به صفحه ورود
            </a>
        </p>
    </form>
