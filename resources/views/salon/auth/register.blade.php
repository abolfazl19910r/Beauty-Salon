<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <h2 class="text-2xl font-bold" style="font-family:'Noto Naskh Arabic','Vazirmatn',serif; color:#E6CD8A">ثبت نام در {{ $salon->name }}</h2>
        <p class="text-sm text-[#F8F3E9]/60 mt-1">برای استفاده از خدمات ما ثبت نام کنید</p>
    </div>

    <form method="POST" action="{{ route('salon.register') }}" class="space-y-5">
        @csrf
        ...
        <p class="text-center text-sm text-[#F8F3E9]/60">
            ...
            <a href="{{ route('salon.login') }}" class="text-[#E6CD8A] hover:text-[#C9A24B] transition-colors font-medium mr-1">
                ورود به حساب
            </a>
        </p>
    </form>
