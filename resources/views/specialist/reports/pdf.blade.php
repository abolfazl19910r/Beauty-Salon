...
<div class="report-header">
    <div class="brand">{{ $specialist->salon?->name ?? config('brand.name') }} — سالن زیبایی</div>
    <div class="doc-title">
...
<div class="footer">
    این گزارش توسط سیستم مدیریت سالن زیبایی {{ $specialist->salon?->name ?? config('brand.name') }} به صورت خودکار صادر شده است.
</div>
