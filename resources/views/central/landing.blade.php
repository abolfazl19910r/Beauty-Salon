            ...
            <div class="aud">
                ...
                <div class="aud-col aud-specialist">
                    ...
                    <ul>
                        ...
                        <li>ویرایش پروفایل عمومی و نمونه‌کارها</li>
                    </ul>
                </div>
    ...
    <section id="faq" style="padding-top: 1rem;" aria-labelledby="faq-title">
        <div class="wrap faq">
            ...
            <details>
                ...
                <p>
                    پیش‌پرداخت نوبت‌ها از درگاه زرین‌پال انجام می‌شود. برای واریز مستقیم به حساب سالن خودتان، کد پذیرنده‌ی
                    زرین‌پالتان را از طریق تیکت پشتیبانی برای ما بفرستید تا روی سالن شما تنظیم شود.
                </p>
            </details>
            <details>
